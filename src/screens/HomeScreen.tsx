                        ...
                        <View style={styles.appointmentActions}>
                          ...
                          >
                            <Text style={styles.actionButtonPrimaryText}>
                              {isNextAppointment ? 'Get Directions' : 'Confirm Booking'}
                            </Text>
                          </TouchableOpacity>
                          <TouchableOpacity
                            style={styles.actionButtonSecondary}
                            onPress={() => isNextAppointment ? handleReschedule(apt.id) : handleCancel(apt.id)}
                          >
                            <Text style={styles.actionButtonSecondaryText}>
                              {isNextAppointment ? 'Reschedule' : 'Cancel'}
                            </Text>
                          </TouchableOpacity>
                        </View>
                      </View>
                    ...
                    <View style={styles.activityItem}>
                      ...
                      <View style={styles.activityContent}>
                        ...
                        <Text style={styles.activitySubtitle}>
                          {activity.serviceName} with {activity.barberName || 'Barber'}
                        </Text>
                        <Text style={styles.activityDate}>
                          {formatActivityDate(activity.appointmentDate || activity.date || '')}
                        </Text>
                      </View>
